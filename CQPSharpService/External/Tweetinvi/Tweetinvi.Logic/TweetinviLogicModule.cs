...
namespace Tweetinvi.Logic
{
    public class TweetinviLogicModule : ITweetinviModule
    {
        ...
        private void InitializeTwitterModels()
        {
            ...
            _container.RegisterType<ISavedSearch, Model.SavedSearch>();
        }
        ...
        {
            _container.RegisterType<IExceptionHandler, Exceptions.ExceptionHandler>(RegistrationLifetime.InstancePerThread);
