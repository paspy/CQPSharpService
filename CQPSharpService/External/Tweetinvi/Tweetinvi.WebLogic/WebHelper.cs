...
namespace Tweetinvi.WebLogic
{
    public class WebHelper : IWebHelper
    {
        ...
        public System.IO.Stream GetResponseStream(string url)
        {
            if (!ValidateUrl(url))
            {
                return null;
        ...
        public System.IO.Stream GetResponseStream(WebRequest webRequest)
        {
        ...
        public async Task<System.IO.Stream> GetResponseStreamAsync(string url)
        {
            WebRequest webRequest = WebRequest.Create(url);
            return await GetResponseStreamAsync(webRequest);
        }

        public async Task<System.IO.Stream> GetResponseStreamAsync(WebRequest webRequest)
        {
